...
function check() {
  ...
  if (
    ...
    allFiled[3].innerHTML == allFiled[4].innerHTML &&
    allFiled[3].innerHTML == allFiled[5].innerHTML &&
    allFiled[3].innerHTML != ""
  ) {
    gameOver(3);
  } else if (
    allFiled[6].innerHTML == allFiled[7].innerHTML &&
    allFiled[7].innerHTML == allFiled[8].innerHTML &&
    allFiled[6].innerHTML != ""
  ) {
    gameOver(6);
  } else if (
    allFiled[0].innerHTML == allFiled[4].innerHTML &&
    allFiled[8].innerHTML == allFiled[4].innerHTML &&
    allFiled[0].innerHTML != ""
  ) {
    gameOver(0);
  } else if (
    allFiled[2].innerHTML == allFiled[4].innerHTML &&
    allFiled[2].innerHTML == allFiled[6].innerHTML &&
    allFiled[2].innerHTML != ""
  ) {
    gameOver(2);
  } else if (
    allFiled[0].innerHTML == allFiled[3].innerHTML &&
    allFiled[6].innerHTML == allFiled[0].innerHTML &&
    allFiled[0].innerHTML != ""
  ) {
    gameOver(0);
  } else if (
    allFiled[1].innerHTML == allFiled[4].innerHTML &&
    allFiled[4].innerHTML == allFiled[7].innerHTML &&
    allFiled[1].innerHTML != ""
  ) {
    gameOver(1);
  } else if (
    allFiled[2].innerHTML == allFiled[5].innerHTML &&
    allFiled[2].innerHTML == allFiled[8].innerHTML &&
    allFiled[2].innerHTML != ""
  ) {
    gameOver(2);
  }
